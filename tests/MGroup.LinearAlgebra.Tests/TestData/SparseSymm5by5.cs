namespace MGroup.LinearAlgebra.Tests.TestData
{
	...
	/// </summary>
	public static class SparseSymm5by5
	{
		...
		public static double[] CscValues => new double[] {
			11.0, 12.0, 44.0, 45.0, 34.0, 45.0, 55.0, 34.0, 33.0, 23.0, 12.0, 23.0, 22.0 };
		public static int[] CscRowIndices => new int[] { 0, 4, 1, 2, 3, 1, 2, 1, 3, 4, 0, 3, 4 };
		public static int[] CscColOffsets => new int[] { 0, 2, 5, 7, 10, 13 };

		public static double[] CscUpperValues => new double[] {
			11.0, 44.0, 45.0, 55.0, 34.0, 33.0, 12.0, 23.0, 22.0 };
		public static int[] CscUpperRowIndices => new int[] { 0, 1, 1, 2, 1, 3, 0, 3, 4 };
		public static int[] CscUpperColOffsets => new int[] { 0, 1, 2, 4, 6, 9 };

		/// <summary>
		/// New-to-old permutation resulting from Matlab's AMD algorithm. 0-based indexing is used.
		/// </summary>
		public static int[] MatlabPermutationAMD => new int[] { 2, 1, 3, 0, 4 };
	}
}
