...
namespace MGroup.LinearAlgebra.Orthogonalization
{
	...
	public class QRFactorization
	{
		...
		public static QRFactorization Factorize(int numRows, int numCols, double[] matrix)
		{
			...
			GlobalProvider.LapackLeastSquares.Dgeqrf(numRows, numCols, matrix, 0, leadingDimA, reflectorScalars, 0);
		...
		public Matrix GetEconomyFactorQ()
		{
			...
			GlobalProvider.LapackLeastSquares.Dorgqr(
				numRowsQ, numColsQ, numReflectors, matrixQ, 0, leadingDimQ, reflectorScalars, 0);
		...
		public Vector SolveLeastSquares(Vector rhsVector) //TODO: perhaps I should use the driver routines of LAPACKE
		{
			...
			GlobalProvider.LapackLeastSquares.Dormqr(
				MultiplicationSide.Left, TransposeMatrix.Transpose, numRowsC, numColsC, numReflectors,
			...
			GlobalProvider.Blas.Dtrsv(StoredTriangle.Upper, TransposeMatrix.NoTranspose, DiagonalValues.NonUnit,
