...
namespace MGroup.LinearAlgebra.Orthogonalization
{
	...
	public class LQFactorization
	{
		...
		public static LQFactorization Factorize(int numRows, int numCols, double[] matrix)
		{
			...
			GlobalProvider.LapackLeastSquares.Dgelqf(numRows, numCols, matrix, 0, leadingDimA, reflectorScalars, 0);
		...
		public Matrix GetFactorQ()
		{
			...
			GlobalProvider.LapackLeastSquares.Dorglq(
		...
		public Vector SolveMinNorm(Vector rhsVector) //TODO: perhaps I should use the driver routines of LAPACKE
		{
			...
			GlobalProvider.Blas.Dtrsv(StoredTriangle.Lower, TransposeMatrix.NoTranspose, DiagonalValues.NonUnit,
			...
			GlobalProvider.LapackLeastSquares.Dormlq(MultiplicationSide.Left, TransposeMatrix.Transpose, numRowsC, numColsC, k,
