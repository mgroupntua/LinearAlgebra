...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLARZB
    {
        ...
        public DLARZB(LSAME lsame, DCOPY dcopy, DGEMM dgemm, DTRMM dtrmm, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _dcopy = dcopy; _dgemm = dgemm; _dtrmm = dtrmm; _xerbla = xerbla; 
                         ...
                         , ref double[] C, int offset_c, int LDC, ref double[] WORK, int offset_work, int LDWORK)
        {
            ...
            var TRANST = new string(' ', 1); var I = 0; var INFO = 0; var J = 0; 
            ...
            if (_lsame.Run(SIDE, "L"))
            {
                ...
                if (L > 0)
                {
                    _dgemm.Run("Transpose", "Transpose", N, K, L, ONE
                ...
                if (L > 0)
                {
                    _dgemm.Run("Transpose", "Transpose", L, N, K,  - ONE
            ...
            else
            {
                if (_lsame.Run(SIDE, "R"))
                {
                    ...
                    if (L > 0)
                    {
                        _dgemm.Run("No transpose", "Transpose", M, K, L, ONE
                    ...
                    if (L > 0)
                    {
                        _dgemm.Run("No transpose", "No transpose", M, L, K,  - ONE
