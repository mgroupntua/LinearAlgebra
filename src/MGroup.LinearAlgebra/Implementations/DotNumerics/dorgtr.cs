...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORGTR
    {
        ...
        public DORGTR(LSAME lsame, ILAENV ilaenv, DORGQL dorgql, DORGQR dorgqr, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _ilaenv = ilaenv; _dorgql = dorgql; _dorgqr = dorgqr; _xerbla = xerbla; 
                         ...
                         , int LWORK, ref int INFO)
        {
            ...
            var LQUERY = false; var UPPER = false; var I = 0; var IINFO = 0; var J = 0; var LWKOPT = 0; var NB = 0; 
            ...
            var A_J = 0; var A_0 = 0; var A_N = 0; var A_1 = 0; 
            ...
            if (INFO == 0)
            {
                if (UPPER)
                {
                    NB = _ilaenv.Run(1, "DORGQL", " ", N - 1, N - 1, N - 1,  - 1);
                }
                else
                {
                    NB = _ilaenv.Run(1, "DORGQR", " ", N - 1, N - 1, N - 1,  - 1);
                }
            ...
            if (UPPER)
            {
                ...
                // *
                _dorgql.Run(N - 1, N - 1, N - 1, ref A, offset_a, LDA, TAU, offset_tau
            ...
            else
            {
                ...
                if (N > 1)
                {
                    ...
                    // *           Generate Q(2:n,2:n)
                    // *
                    _dorgqr.Run(N - 1, N - 1, N - 1, ref A, 2+2 * LDA + o_a, LDA, TAU, offset_tau
                                     , ref WORK, offset_work, LWORK, ref IINFO);
                }
            }
            WORK[1 + o_work] = LWKOPT;
