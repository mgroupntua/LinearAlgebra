...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASRT
    {
        ...
        public void Run(string ID, int N, ref double[] D, int offset_d, ref int INFO)
        {
            ...
            var DIR = 0; var ENDD = 0; var I = 0; var J = 0; var START = 0; var STKPNT = 0; double D1 = 0; double D2 = 0; 
            double D3 = 0;double DMNMX = 0; double TMP = 0; var o_stack = -3; 
