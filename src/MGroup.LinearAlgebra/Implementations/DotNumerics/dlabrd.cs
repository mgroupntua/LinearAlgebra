...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLABRD
    {
        ...
        public DLABRD(DGEMV dgemv, DLARFG dlarfg, DSCAL dscal)
        {
            ...
            _dgemv = dgemv; _dlarfg = dlarfg; _dscal = dscal; 
                         ...
                         , int LDY)
        {
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_d = -1 + offset_d;  var o_e = -1 + offset_e;  var o_tauq = -1 + offset_tauq; 
             var o_taup = -1 + offset_taup; var o_x = -1 - LDX + offset_x;  var o_y = -1 - LDY + offset_y; 
            ...
            if (M >= N)
            {
                ...
                for (I = 1; I <= NB; I++)
                {
                    ...
                    // *           Update A(i:m,i)
                    // *
                    _dgemv.Run("No transpose", M - I + 1, I - 1,  - ONE, A, I+1 * LDA + o_a, LDA
                                    , Y, I+1 * LDY + o_y, LDY, ONE, ref A, I+I * LDA + o_a, 1);
                    _dgemv.Run("No transpose", M - I + 1, I - 1,  - ONE, X, I+1 * LDX + o_x, LDX
                                    , A, 1+I * LDA + o_a, 1, ONE, ref A, I+I * LDA + o_a, 1);
                    // *
                    // *           Generate reflection Q(i) to annihilate A(i+1:m,i)
                    // *
                    _dlarfg.Run(M - I + 1, ref A[I+I * LDA + o_a], ref A, Math.Min(I + 1, M)+I * LDA + o_a, 1, ref TAUQ[I + o_tauq]);
                    ...
                    if (I < N)
                    {
                        ...
                        // *              Compute Y(i+1:n,i)
                        // *
                        _dgemv.Run("Transpose", M - I + 1, N - I, ONE, A, I+(I + 1) * LDA + o_a, LDA
                                        , A, I+I * LDA + o_a, 1, ZERO, ref Y, I + 1+I * LDY + o_y, 1);
                        _dgemv.Run("Transpose", M - I + 1, I - 1, ONE, A, I+1 * LDA + o_a, LDA
                                        , A, I+I * LDA + o_a, 1, ZERO, ref Y, 1+I * LDY + o_y, 1);
                        _dgemv.Run("No transpose", N - I, I - 1,  - ONE, Y, I + 1+1 * LDY + o_y, LDY
                                        , Y, 1+I * LDY + o_y, 1, ONE, ref Y, I + 1+I * LDY + o_y, 1);
                        _dgemv.Run("Transpose", M - I + 1, I - 1, ONE, X, I+1 * LDX + o_x, LDX
                                        , A, I+I * LDA + o_a, 1, ZERO, ref Y, 1+I * LDY + o_y, 1);
                        _dgemv.Run("Transpose", I - 1, N - I,  - ONE, A, 1+(I + 1) * LDA + o_a, LDA
                                        , Y, 1+I * LDY + o_y, 1, ONE, ref Y, I + 1+I * LDY + o_y, 1);
                        _dscal.Run(N - I, TAUQ[I + o_tauq], ref Y, I + 1+I * LDY + o_y, 1);
                        // *
                        // *              Update A(i,i+1:n)
                        // *
                        _dgemv.Run("No transpose", N - I, I,  - ONE, Y, I + 1+1 * LDY + o_y, LDY
                        ...
                        // *
                        _dlarfg.Run(N - I, ref A[I+(I + 1) * LDA + o_a], ref A, I+Math.Min(I + 2, N) * LDA + o_a, LDA, ref TAUP[I + o_taup]);
                        E[I + o_e] = A[I+(I + 1) * LDA + o_a];
                        A[I+(I + 1) * LDA + o_a] = ONE;
                        // *
                        // *              Compute X(i+1:m,i)
                        // *
                        _dgemv.Run("No transpose", M - I, N - I, ONE, A, I + 1+(I + 1) * LDA + o_a, LDA
                                        , A, I+(I + 1) * LDA + o_a, LDA, ZERO, ref X, I + 1+I * LDX + o_x, 1);
                        _dgemv.Run("Transpose", N - I, I, ONE, Y, I + 1+1 * LDY + o_y, LDY
                                        , A, I+(I + 1) * LDA + o_a, LDA, ZERO, ref X, 1+I * LDX + o_x, 1);
                        _dgemv.Run("No transpose", M - I, I,  - ONE, A, I + 1+1 * LDA + o_a, LDA
                                        , X, 1+I * LDX + o_x, 1, ONE, ref X, I + 1+I * LDX + o_x, 1);
                        _dgemv.Run("No transpose", I - 1, N - I, ONE, A, 1+(I + 1) * LDA + o_a, LDA
                                        , A, I+(I + 1) * LDA + o_a, LDA, ZERO, ref X, 1+I * LDX + o_x, 1);
                        _dgemv.Run("No transpose", M - I, I - 1,  - ONE, X, I + 1+1 * LDX + o_x, LDX
                                        , X, 1+I * LDX + o_x, 1, ONE, ref X, I + 1+I * LDX + o_x, 1);
                        _dscal.Run(M - I, TAUP[I + o_taup], ref X, I + 1+I * LDX + o_x, 1);
                    }
                }
            }
            else
            {
                ...
                for (I = 1; I <= NB; I++)
                {
                    ...
                    // *           Update A(i,i:n)
                    // *
                    _dgemv.Run("No transpose", N - I + 1, I - 1,  - ONE, Y, I+1 * LDY + o_y, LDY
                                    , A, I+1 * LDA + o_a, LDA, ONE, ref A, I+I * LDA + o_a, LDA);
                    _dgemv.Run("Transpose", I - 1, N - I + 1,  - ONE, A, 1+I * LDA + o_a, LDA
                                    , X, I+1 * LDX + o_x, LDX, ONE, ref A, I+I * LDA + o_a, LDA);
                    // *
                    // *           Generate reflection P(i) to annihilate A(i,i+1:n)
                    // *
                    _dlarfg.Run(N - I + 1, ref A[I+I * LDA + o_a], ref A, I+Math.Min(I + 1, N) * LDA + o_a, LDA, ref TAUP[I + o_taup]);
                    D[I + o_d] = A[I+I * LDA + o_a];
                    if (I < M)
                    {
                        A[I+I * LDA + o_a] = ONE;
                        ...
                        // *              Compute X(i+1:m,i)
                        // *
                        _dgemv.Run("No transpose", M - I, N - I + 1, ONE, A, I + 1+I * LDA + o_a, LDA
                                        , A, I+I * LDA + o_a, LDA, ZERO, ref X, I + 1+I * LDX + o_x, 1);
                        _dgemv.Run("Transpose", N - I + 1, I - 1, ONE, Y, I+1 * LDY + o_y, LDY
                                        , A, I+I * LDA + o_a, LDA, ZERO, ref X, 1+I * LDX + o_x, 1);
                        _dgemv.Run("No transpose", M - I, I - 1,  - ONE, A, I + 1+1 * LDA + o_a, LDA
                                        , X, 1+I * LDX + o_x, 1, ONE, ref X, I + 1+I * LDX + o_x, 1);
                        _dgemv.Run("No transpose", I - 1, N - I + 1, ONE, A, 1+I * LDA + o_a, LDA
                                        , A, I+I * LDA + o_a, LDA, ZERO, ref X, 1+I * LDX + o_x, 1);
                        _dgemv.Run("No transpose", M - I, I - 1,  - ONE, X, I + 1+1 * LDX + o_x, LDX
                                        , X, 1+I * LDX + o_x, 1, ONE, ref X, I + 1+I * LDX + o_x, 1);
                        _dscal.Run(M - I, TAUP[I + o_taup], ref X, I + 1+I * LDX + o_x, 1);
                        ...
                        _dgemv.Run("No transpose", M - I, I,  - ONE, X, I + 1+1 * LDX + o_x, LDX
                                        , A, 1+I * LDA + o_a, 1, ONE, ref A, I + 1+I * LDA + o_a, 1);
                        // *
                        // *              Generate reflection Q(i) to annihilate A(i+2:m,i)
                        // *
                        _dlarfg.Run(M - I, ref A[I + 1+I * LDA + o_a], ref A, Math.Min(I + 2, M)+I * LDA + o_a, 1, ref TAUQ[I + o_tauq]);
                        E[I + o_e] = A[I + 1+I * LDA + o_a];
                        A[I + 1+I * LDA + o_a] = ONE;
                        // *
                        // *              Compute Y(i+1:n,i)
                        // *
                        _dgemv.Run("Transpose", M - I, N - I, ONE, A, I + 1+(I + 1) * LDA + o_a, LDA
                                        , A, I + 1+I * LDA + o_a, 1, ZERO, ref Y, I + 1+I * LDY + o_y, 1);
                        _dgemv.Run("Transpose", M - I, I - 1, ONE, A, I + 1+1 * LDA + o_a, LDA
                                        , A, I + 1+I * LDA + o_a, 1, ZERO, ref Y, 1+I * LDY + o_y, 1);
                        _dgemv.Run("No transpose", N - I, I - 1,  - ONE, Y, I + 1+1 * LDY + o_y, LDY
                                        , Y, 1+I * LDY + o_y, 1, ONE, ref Y, I + 1+I * LDY + o_y, 1);
                        _dgemv.Run("Transpose", M - I, I, ONE, X, I + 1+1 * LDX + o_x, LDX
                                        , A, I + 1+I * LDA + o_a, 1, ZERO, ref Y, 1+I * LDY + o_y, 1);
                        _dgemv.Run("Transpose", I, N - I,  - ONE, A, 1+(I + 1) * LDA + o_a, LDA
                                        , Y, 1+I * LDY + o_y, 1, ONE, ref Y, I + 1+I * LDY + o_y, 1);
                        _dscal.Run(N - I, TAUQ[I + o_tauq], ref Y, I + 1+I * LDY + o_y, 1);
                    }
                }
