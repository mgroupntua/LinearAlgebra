...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORG2L
    {
        ...
        public DORG2L(DLARF dlarf, DSCAL dscal, XERBLA xerbla)
        {
            ...
            _dlarf = dlarf; _dscal = dscal; _xerbla = xerbla; 
                         ...
                         , ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            var I = 0; var II = 0; var J = 0; var L = 0; 
            ...
            for (I = 1; I <= K; I++)
            {
                ...
                _dlarf.Run("Left", M - N + II, II - 1, A, 1+II * LDA + o_a, 1, TAU[I + o_tau]
                                , ref A, offset_a, LDA, ref WORK, offset_work);
                _dscal.Run(M - N + II - 1,  - TAU[I + o_tau], ref A, 1+II * LDA + o_a, 1);
