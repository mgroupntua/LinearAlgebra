...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAED7
    {
        ...
        public DLAED7(DGEMM dgemm, DLAED8 dlaed8, DLAED9 dlaed9, DLAEDA dlaeda, DLAMRG dlamrg, XERBLA xerbla)
        {
            ...
            _dgemm = dgemm; _dlaed8 = dlaed8; _dlaed9 = dlaed9; _dlaeda = dlaeda; _dlamrg = dlamrg; 
            _xerbla = xerbla;
                         ...
                         , ref double[] GIVNUM, int offset_givnum, ref double[] WORK, int offset_work, ref int[] IWORK, int offset_iwork, ref int INFO)
        {
            ...
            var COLTYP = 0; var CURR = 0; var I = 0; var IDLMDA = 0; var INDX = 0; var INDXC = 0; var INDXP = 0; var IQ2 = 0; 
            var IS = 0;var IW = 0; var IZ = 0; var K = 0; var LDQ2 = 0; var N1 = 0; var N2 = 0; var PTR = 0; 
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_q = -1 - LDQ + offset_q;  var o_indxq = -1 + offset_indxq; 
             var o_qstore = -1 + offset_qstore; var o_qptr = -1 + offset_qptr;  var o_prmptr = -1 + offset_prmptr; 
             var o_perm = -1 + offset_perm; var o_givptr = -1 + offset_givptr;  var o_givcol = -3 + offset_givcol; 
             var o_givnum = -3 + offset_givnum; var o_work = -1 + offset_work;  var o_iwork = -1 + offset_iwork; 
            ...
            CURR = PTR + CURPBM;
            _dlaeda.Run(N, TLVLS, CURLVL, CURPBM, PRMPTR, offset_prmptr, PERM, offset_perm
            ...
            // *
            _dlaed8.Run(ICOMPQ, ref K, N, QSIZ, ref D, offset_d, ref Q, offset_q
            ...
            if (K != 0)
            {
                ...
                N1 = K;
                N2 = N - K;
                _dlamrg.Run(N1, N2, D, offset_d, 1,  - 1, ref INDXQ, offset_indxq);
            }
            else
            {
