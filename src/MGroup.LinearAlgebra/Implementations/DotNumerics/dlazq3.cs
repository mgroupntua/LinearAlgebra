...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAZQ3
    {
        ...
        public DLAZQ3(DLASQ5 dlasq5, DLASQ6 dlasq6, DLAZQ4 dlazq4, DLAMCH dlamch)
        {
            ...
            _dlasq5 = dlasq5; _dlasq6 = dlasq6; _dlazq4 = dlazq4; _dlamch = dlamch; 
                         ...
                         , ref double TAU)
        {
            ...
            var IPN4 = 0; var J4 = 0; var N0IN = 0; var NN = 0; double EPS = 0; double G = 0; double S = 0; double SAFMIN = 0; 
        ...
        LABEL50:;
            ...
            if (DMIN < ZERO || SAFMIN * QMAX < Math.Min(Z[4 * N0 + PP - 1 + o_z], Math.Min(Z[4 * N0 + PP - 9 + o_z], DMIN2 + Z[4 * N0 - PP + o_z])))
            {
                ...
                // *        Choose a shift.
                // *
                _dlazq4.Run(I0, N0, Z, offset_z, PP, N0IN, DMIN
            ...
            LABEL80:;
                // *
                _dlasq5.Run(I0, N0, ref Z, offset_z, PP, TAU, ref DMIN
            ...
            // *
        LABEL90:;
            _dlasq6.Run(I0, N0, ref Z, offset_z, PP, ref DMIN, ref DMIN1
