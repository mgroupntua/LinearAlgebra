...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAED1
    {
        ...
        public DLAED1(DCOPY dcopy, DLAED2 dlaed2, DLAED3 dlaed3, DLAMRG dlamrg, XERBLA xerbla)
        {
            ...
            _dcopy = dcopy; _dlaed2 = dlaed2; _dlaed3 = dlaed3; _dlamrg = dlamrg; _xerbla = xerbla; 
                         ...
                         , int CUTPNT, ref double[] WORK, int offset_work, ref int[] IWORK, int offset_iwork, ref int INFO)
        {
            ...
            var COLTYP = 0; var I = 0; var IDLMDA = 0; var INDX = 0; var INDXC = 0; var INDXP = 0; var IQ2 = 0; var IS = 0; 
            var IW = 0;var IZ = 0; var K = 0; var N1 = 0; var N2 = 0; var ZPP1 = 0; 
            ...
            // *     first row of Q_2.
            // *
            _dcopy.Run(CUTPNT, Q, CUTPNT+1 * LDQ + o_q, LDQ, ref WORK, IZ + o_work, 1);
            ZPP1 = CUTPNT + 1;
            _dcopy.Run(N - CUTPNT, Q, ZPP1+ZPP1 * LDQ + o_q, LDQ, ref WORK, IZ + CUTPNT + o_work, 1);
            // *
            // *     Deflate eigenvalues.
            // *
            _dlaed2.Run(ref K, N, CUTPNT, ref D, offset_d, ref Q, offset_q, LDQ
            ...
            if (K != 0)
            {
                ...
                _dlaed3.Run(K, N, CUTPNT, ref D, offset_d, ref Q, offset_q, LDQ
