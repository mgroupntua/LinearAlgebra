...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DTREXC
    {
        ...
        public DTREXC(LSAME lsame, DLAEXC dlaexc, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _dlaexc = dlaexc; _xerbla = xerbla; 
                         ...
                         , ref int IFST, ref int ILST, ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            var WANTQ = false; var HERE = 0; var NBF = 0; var NBL = 0; var NBNEXT = 0; 
            ...
            INFO = 0;
            WANTQ = _lsame.Run(COMPQ, "V");
            if (!WANTQ && !_lsame.Run(COMPQ, "N"))
            {
                INFO =  - 1;
            }
            else
            ...
            LABEL10:;
                ...
                if (NBF == 1 || NBF == 2)
                {
                    ...
                    _dlaexc.Run(WANTQ, N, ref T, offset_t, LDT, ref Q, offset_q, LDQ
