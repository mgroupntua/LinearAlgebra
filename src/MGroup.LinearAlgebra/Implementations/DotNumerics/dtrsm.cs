...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DTRSM
    {
                         ...
                         , double ALPHA, double[] A, int offset_a, int LDA, ref double[] B, int offset_b, int LDB)
        {
            ...
            double TEMP = 0; var I = 0; var INFO = 0; var J = 0; var K = 0; var NROWA = 0; var LSIDE = false; 
            var NOUNIT = false;var UPPER = false; 
            ...
            var B_J = 0; var A_K = 0; var A_I = 0; var B_K = 0; 
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_b = -1 - LDB + offset_b; 
            ...
            else
            {
                ...
                {
                    if (!_lsame.Run(TRANSA, "N") && !_lsame.Run(TRANSA, "T") && !_lsame.Run(TRANSA, "C"))
                    {
                        INFO = 3;
                    }
                    else
                    {
                        if (!_lsame.Run(DIAG, "U") && !_lsame.Run(DIAG, "N"))
                        {
                            INFO = 4;
                        }
                        else
