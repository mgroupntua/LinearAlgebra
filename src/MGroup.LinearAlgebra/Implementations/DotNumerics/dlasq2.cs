...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASQ2
    {
        ...
        public DLASQ2(DLAZQ3 dlazq3, DLASRT dlasrt, XERBLA xerbla, DLAMCH dlamch, ILAENV ilaenv)
        {
            ...
            _dlazq3 = dlazq3; _dlasrt = dlasrt; _xerbla = xerbla; _dlamch = dlamch; _ilaenv = ilaenv; 
        ...
        public void Run(int N, ref double[] Z, int offset_z, ref int INFO)
        {
            ...
            var IEEE = false; var I0 = 0; var I4 = 0; var IINFO = 0; var IPN4 = 0; var ITER = 0; var IWHILA = 0; var IWHILB = 0; 
            var K = 0;var N0 = 0; var NBIG = 0; var NDIV = 0; var NFAIL = 0; var PP = 0; var SPLT = 0; var TTYPE = 0; 
            ...
            if (E == ZERO)
            {
                ...
                _dlasrt.Run("D", N, ref Z, offset_z, ref IINFO);
                Z[2 * N - 1 + o_z] = D;
                return;
            }
            // *
            ...
            // *         
            IEEE = _ilaenv.Run(10, "DLASQ2", "N", 1, 2, 3, 4) == 1 && _ilaenv.Run(11, "DLASQ2", "N", 1, 2, 3, 4) == 1;
            // *         
            ...
            LABEL100:;
                ...
                for (IWHILB = 1; IWHILB <= NBIG; IWHILB++)
                {
                    ...
                    // *
                    _dlazq3.Run(I0, ref N0, ref Z, offset_z, PP, ref DMIN, ref SIGMA
