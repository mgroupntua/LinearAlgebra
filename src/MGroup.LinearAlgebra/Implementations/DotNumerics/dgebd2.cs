...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGEBD2
    {
        ...
        public DGEBD2(DLARF dlarf, DLARFG dlarfg, XERBLA xerbla)
        {
            ...
            _dlarf = dlarf; _dlarfg = dlarfg; _xerbla = xerbla; 
                         ...
                         , ref double[] TAUQ, int offset_tauq, ref double[] TAUP, int offset_taup, ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            #region Array Index Correction
             ...
             var o_taup = -1 + offset_taup; var o_work = -1 + offset_work; 
            ...
            if (M >= N)
            {
                ...
                for (I = 1; I <= N; I++)
                {
                    ...
                    if (I < N)
                    {
                        _dlarf.Run("Left", M - I + 1, N - I, A, I+I * LDA + o_a, 1, TAUQ[I + o_tauq]
                    ...
                    if (I < N)
                    {
                        ...
                        // *
                        _dlarf.Run("Right", M - I, N - I, A, I+(I + 1) * LDA + o_a, LDA, TAUP[I + o_taup]
            ...
            else
            {
                ...
                for (I = 1; I <= M; I++)
                {
                    ...
                    if (I < M)
                    {
                        _dlarf.Run("Right", M - I, N - I + 1, A, I+I * LDA + o_a, LDA, TAUP[I + o_taup]
                    ...
                    if (I < M)
                    {
                        ...
                        // *
                        _dlarf.Run("Left", M - I, N - I, A, I + 1+I * LDA + o_a, 1, TAUQ[I + o_tauq]
                                        , ref A, I + 1+(I + 1) * LDA + o_a, LDA, ref WORK, offset_work);
