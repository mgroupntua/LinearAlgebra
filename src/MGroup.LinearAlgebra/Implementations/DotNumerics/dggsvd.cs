...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGGSVD
    {
        ...
        public DGGSVD(LSAME lsame, DLAMCH dlamch, DLANGE dlange, DCOPY dcopy, DGGSVP dggsvp, DTGSJA dtgsja, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _dlamch = dlamch; _dlange = dlange; _dcopy = dcopy; _dggsvp = dggsvp; 
            _dtgsja = dtgsja;_xerbla = xerbla; 
        ...
        public DGGSVD()
        {
            ...
            var dggsvp = new DGGSVP(lsame, dgeqpf, dgeqr2, dgerq2, dlacpy, dlapmt, dlaset, dorg2r, dorm2r, dormr2
                                       , xerbla);
            ...
            var dtgsja = new DTGSJA(lsame, dcopy, dlags2, dlapll, dlartg, dlaset, drot, dscal, xerbla);
                         ...
                         , ref double[] Q, int offset_q, int LDQ, ref double[] WORK, int offset_work, ref int[] IWORK, int offset_iwork, ref int INFO)
        {
            ...
            var WANTQ = false; var WANTU = false; var WANTV = false; var I = 0; var IBND = 0; var ISUB = 0; var J = 0; 
            var NCYCLE = 0;double ANORM = 0; double BNORM = 0; double SMAX = 0; double TEMP = 0; double TOLA = 0; double TOLB = 0; 
            ...
            #region Array Index Correction
             ...
             var o_q = -1 - LDQ + offset_q; var o_work = -1 + offset_work;  var o_iwork = -1 + offset_iwork; 
            ...
            if (INFO != 0)
            {
                _xerbla.Run("DGGSVD",  - INFO);
                return;
            }
            // *
            // *     Compute the Frobenius norm of matrices A and B
            // *
            ANORM = _dlange.Run("1", M, N, A, offset_a, LDA, ref WORK, offset_work);
            BNORM = _dlange.Run("1", P, N, B, offset_b, LDB, ref WORK, offset_work);
            // *
            ...
            // *     Preprocessing
            // *
            _dggsvp.Run(JOBU, JOBV, JOBQ, M, P, N
            ...
            // *
            _dtgsja.Run(JOBU, JOBV, JOBQ, M, P, N
            ...
            // *
            _dcopy.Run(N, ALPHA, offset_alpha, 1, ref WORK, offset_work, 1);
            IBND = Math.Min(L, M - K);
            for (I = 1; I <= IBND; I++)
            {
                // *
