...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DDISNA
    {
        ...
        public DDISNA(LSAME lsame, DLAMCH dlamch, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _dlamch = dlamch; _xerbla = xerbla; 
        ...
        public void Run(string JOB, int M, int N, double[] D, int offset_d, ref double[] SEP, int offset_sep, ref int INFO)
        {
            ...
            var DECR = false; var EIGEN = false; var INCR = false; var LEFT = false; var RIGHT = false; var SING = false; 
            var I = 0;var K = 0; double ANORM = 0; double EPS = 0; double NEWGAP = 0; double OLDGAP = 0; double SAFMIN = 0; 
            double THRESH = 0;
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_sep = -1 + offset_sep; 
            ...
            INFO = 0;
            EIGEN = _lsame.Run(JOB, "E");
            LEFT = _lsame.Run(JOB, "L");
            RIGHT = _lsame.Run(JOB, "R");
            SING = LEFT || RIGHT;
            if (EIGEN)
            {
                K = M;
