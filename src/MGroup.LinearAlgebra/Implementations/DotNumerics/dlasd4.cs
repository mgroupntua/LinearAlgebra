...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASD4
    {
        ...
        public DLASD4(DLAED6 dlaed6, DLASD5 dlasd5, DLAMCH dlamch)
        {
            ...
            _dlaed6 = dlaed6; _dlasd5 = dlasd5; _dlamch = dlamch; 
                         ...
                         , ref double SIGMA, ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            var ORGATI = false; var SWTCH = false; var SWTCH3 = false; var II = 0; var IIM1 = 0; var IIP1 = 0; var IP1 = 0; 
            var ITER = 0;var J = 0; var NITER = 0; double A = 0; double B = 0; double C = 0; double DELSQ = 0; double DELSQ2 = 0; 
            ...
            double TEMP = 0;double TEMP1 = 0; double TEMP2 = 0; double W = 0; var offset_dd = 0; var o_dd = -1; 
            var offset_zz = 0; var o_zz = -1;
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_z = -1 + offset_z;  var o_delta = -1 + offset_delta;  var o_work = -1 + offset_work; 
            ...
            if (N == 2)
            {
                _dlasd5.Run(I, D, offset_d, Z, offset_z, ref DELTA, offset_delta, RHO, ref SIGMA
            ...
            else
            {
                ...
                else
                {
                    ...
                    DD[3 + o_dd] = DTIIP;
                    _dlaed6.Run(NITER, ORGATI, C, DD, offset_dd, ZZ, offset_zz, W
                                     , ref ETA, ref INFO);
