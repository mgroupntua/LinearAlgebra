...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DTBSV
    {
                         ...
                         , int LDA, ref double[] X, int offset_x, int INCX)
        {
            ...
            double TEMP = 0; var I = 0; var INFO = 0; var IX = 0; var J = 0; var JX = 0; var KPLUS1 = 0; var KX = 0; var L = 0; 
            var NOUNIT = false;
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_x = -1 + offset_x; 
            ...
            INFO = 0;
            if (!_lsame.Run(UPLO, "U") && !_lsame.Run(UPLO, "L"))
            {
                INFO = 1;
            }
            else
