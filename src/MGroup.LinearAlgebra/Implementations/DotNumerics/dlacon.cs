...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLACON
    {
        ...
        public DLACON(IDAMAX idamax, DASUM dasum, DCOPY dcopy)
        {
            ...
            _idamax = idamax; _dasum = dasum; _dcopy = dcopy; 
        ...
        public void Run(int N, ref double[] V, int offset_v, ref double[] X, int offset_x, ref int[] ISGN, int offset_isgn, ref double EST, ref int KASE)
        {
            ...
            #region Array Index Correction
             ...
             var o_v = -1 + offset_v;  var o_x = -1 + offset_x;  var o_isgn = -1 + offset_isgn; 
        ...
        LABEL50:;
            ...
            // *
        LABEL70:;
            _dcopy.Run(N, X, offset_x, 1, ref V, offset_v, 1);
            ESTOLD = EST;
            EST = _dasum.Run(N, V, offset_v, 1);
            for (I = 1; I <= N; I++)
            {
        ...
        LABEL120:;
            ...
            // *
        LABEL140:;
            TEMP = TWO * (_dasum.Run(N, X, offset_x, 1) / Convert.ToDouble(3 * N));
            if (TEMP > EST)
            {
                _dcopy.Run(N, X, offset_x, 1, ref V, offset_v, 1);
                EST = TEMP;
