...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAR2V
    {
                         ...
                         , double[] S, int offset_s, int INCC)
        {
            ...
            var I = 0; var IC = 0; var IX = 0; double CI = 0; double SI = 0; double T1 = 0; double T2 = 0; double T3 = 0; 
            ...
            #region Array Index Correction
             ...
             var o_x = -1 + offset_x;  var o_y = -1 + offset_y;  var o_z = -1 + offset_z;  var o_c = -1 + offset_c; 
             var o_s = -1 + offset_s;
