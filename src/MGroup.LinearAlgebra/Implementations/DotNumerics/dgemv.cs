...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGEMV
    {
                         ...
                         , double[] X, int offset_x, int INCX, double BETA, ref double[] Y, int offset_y, int INCY)
        {
            ...
            double TEMP = 0; var I = 0; var INFO = 0; var IX = 0; var IY = 0; var J = 0; var JX = 0; var JY = 0; var KX = 0; 
            var KY = 0;var LENX = 0; var LENY = 0; 
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_x = -1 + offset_x;  var o_y = -1 + offset_y; 
