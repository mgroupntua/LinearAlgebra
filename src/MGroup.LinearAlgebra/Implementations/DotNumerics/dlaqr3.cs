...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAQR3
    {
                      ...
                      , DLARF dlarf, DLARFG dlarfg, DLASET dlaset, DORGHR dorghr, DTREXC dtrexc)
        {
            ...
            _dlamch = dlamch; _ilaenv = ilaenv; _dcopy = dcopy; _dgehrd = dgehrd; _dgemm = dgemm; 
            _dlabad = dlabad;_dlacpy = dlacpy; _dlahqr = dlahqr; _dlanv2 = dlanv2; _dlaqr4 = dlaqr4; 
            _dlarf = dlarf;_dlarfg = dlarfg; _dlaset = dlaset; _dorghr = dorghr; _dtrexc = dtrexc; 
                         ...
                         , ref double[] WORK, int offset_work, int LWORK)
        {
            ...
            var LWK1 = 0;var LWK2 = 0; var LWK3 = 0; var LWKOPT = 0; var NMIN = 0; var BULGE = false; var SORTED = false; 
            ...
            else
            {
                ...
                // *
                _dlaqr4.Run(true, true, JW, 1, JW, ref T, offset_t
            ...
            _dlaset.Run("A", JW, JW, ZERO, ONE, ref V, offset_v
                             , LDV);
            NMIN = _ilaenv.Run(12, "DLAQR3", "SV", JW, 1, JW, LWORK);
            if (JW > NMIN)
            {
                _dlaqr4.Run(true, true, JW, 1, JW, ref T, offset_t
