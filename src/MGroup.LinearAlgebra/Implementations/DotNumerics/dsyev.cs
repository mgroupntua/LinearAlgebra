...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DSYEV
    {
                     ...
                     , XERBLA xerbla)
        {
            ...
            _lsame = lsame; _ilaenv = ilaenv; _dlamch = dlamch; _dlansy = dlansy; _dlascl = dlascl; 
            _dorgtr = dorgtr;_dscal = dscal; _dsteqr = dsteqr; _dsterf = dsterf; _dsytrd = dsytrd; 
            _xerbla = xerbla;
        ...
        public DSYEV()
        {
            ...
            var dorg2l = new DORG2L(dlarf, dscal, xerbla);
            var dorgql = new DORGQL(dlarfb, dlarft, dorg2l, xerbla, ilaenv);
            var dorg2r = new DORG2R(dlarf, dscal, xerbla);
            var dorgqr = new DORGQR(dlarfb, dlarft, dorg2r, xerbla, ilaenv);
            var dorgtr = new DORGTR(lsame, ilaenv, dorgql, dorgqr, xerbla);
                         ...
                         , ref double[] WORK, int offset_work, int LWORK, ref int INFO)
        {
            ...
            var LOWER = false; var LQUERY = false; var WANTZ = false; var IINFO = 0; var IMAX = 0; var INDE = 0; 
            var INDTAU = 0;var INDWRK = 0; var ISCALE = 0; var LLWORK = 0; var LWKOPT = 0; var NB = 0; double ANRM = 0; 
            ...
            if (INFO == 0)
            {
                NB = _ilaenv.Run(1, "DSYTRD", UPLO, N,  - 1,  - 1,  - 1);
            ...
            {
                _dorgtr.Run(UPLO, N, ref A, offset_a, LDA, WORK, INDTAU + o_work, ref WORK, INDWRK + o_work
                                 , LLWORK, ref IINFO);
                _dsteqr.Run(JOBZ, N, ref W, offset_w, ref WORK, INDE + o_work, ref A, offset_a, LDA
