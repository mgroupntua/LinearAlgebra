...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORMBR
    {
        ...
        public DORMBR(LSAME lsame, ILAENV ilaenv, DORMLQ dormlq, DORMQR dormqr, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _ilaenv = ilaenv; _dormlq = dormlq; _dormqr = dormqr; _xerbla = xerbla; 
                         ...
                         , int LWORK, ref int INFO)
        {
            ...
            var APPLYQ = false; var LEFT = false; var LQUERY = false; var NOTRAN = false; var TRANST = new string(' ', 1); 
            var I1 = 0;var I2 = 0; var IINFO = 0; var LWKOPT = 0; var MI = 0; var NB = 0; var NI = 0; var NQ = 0; var NW = 0; 
            ...
            if (INFO == 0)
            {
                ...
                else
                {
                    if (LEFT)
                    {
                        NB = _ilaenv.Run(1, "DORMLQ", SIDE + TRANS, M - 1, N, M - 1,  - 1);
                    }
                    else
                    {
                        NB = _ilaenv.Run(1, "DORMLQ", SIDE + TRANS, M, N - 1, N - 1,  - 1);
                    }
                }
            ...
            if (APPLYQ)
            {
                ...
                if (NQ >= K)
                {
                    ...
                    // *
                    _dormqr.Run(SIDE, TRANS, M, N, K, ref A, offset_a
            ...
            else
            {
                ...
                if (NQ > K)
                {
                    ...
                    // *
                    _dormlq.Run(SIDE, TRANST, M, N, K, ref A, offset_a
                                     , LDA, TAU, offset_tau, ref C, offset_c, LDC, ref WORK, offset_work, LWORK
                                     , ref IINFO);
                }
                else
                {
                    if (NQ > 1)
                    {
                        ...
                        _dormlq.Run(SIDE, TRANST, MI, NI, NQ - 1, ref A, 1+2 * LDA + o_a
                                         , LDA, TAU, offset_tau, ref C, I1+I2 * LDC + o_c, LDC, ref WORK, offset_work, LWORK
                                         , ref IINFO);
                    }
                }
