...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORGLQ
    {
        ...
        public DORGLQ(DLARFB dlarfb, DLARFT dlarft, DORGL2 dorgl2, XERBLA xerbla, ILAENV ilaenv)
        {
            ...
            _dlarfb = dlarfb; _dlarft = dlarft; _dorgl2 = dorgl2; _xerbla = xerbla; _ilaenv = ilaenv; 
                         ...
                         , ref double[] WORK, int offset_work, int LWORK, ref int INFO)
        {
            ...
            INFO = 0;
            NB = _ilaenv.Run(1, "DORGLQ", " ", M, N, K,  - 1);
            ...
            if (NB > 1 && NB < K)
            {
                ...
                // *
                NX = Math.Max(0, _ilaenv.Run(3, "DORGLQ", " ", M, N, K,  - 1));
                if (NX < K)
                {
                    // *
                    ...
                    if (LWORK < IWS)
                    {
                        ...
                        // *
                        NB = LWORK / LDWORK;
                        NBMIN = Math.Max(2, _ilaenv.Run(2, "DORGLQ", " ", M, N, K,  - 1));
                    }
                }
            }
            // *
            ...
            if (KK < M)
            {
                _dorgl2.Run(M - KK, N - KK, K - KK, ref A, KK + 1+(KK + 1) * LDA + o_a, LDA, TAU, KK + 1 + o_tau
            ...
            if (KK > 0)
            {
                ...
                for (I = KI + 1;  - NB >= 0 ? I <= 1 : I >= 1; I +=  - NB)
                {
                    ...
                    if (I + IB <= M)
                    {
                        ...
                        // *
                        _dlarfb.Run("Right", "Transpose", "Forward", "Rowwise", M - I - IB + 1, N - I + 1
                    ...
                    // *
                    _dorgl2.Run(IB, N - I + 1, IB, ref A, I+I * LDA + o_a, LDA, TAU, I + o_tau
                                     , ref WORK, offset_work, ref IINFO);
                    // *
