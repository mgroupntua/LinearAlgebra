...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASD7
    {
        ...
        public DLASD7(DCOPY dcopy, DLAMRG dlamrg, DROT drot, XERBLA xerbla, DLAMCH dlamch, DLAPY2 dlapy2)
        {
            ...
            _dcopy = dcopy; _dlamrg = dlamrg; _drot = drot; _xerbla = xerbla; _dlamch = dlamch; 
            _dlapy2 = dlapy2;
                         ...
                         , ref double C, ref double S, ref int INFO)
        {
            ...
            var I = 0; var IDXI = 0; var IDXJ = 0; var IDXJP = 0; var J = 0; var JP = 0; var JPREV = 0; var K2 = 0; var M = 0; 
            var N = 0;var NLP1 = 0; var NLP2 = 0; double EPS = 0; double HLFTOL = 0; double TAU = 0; double TOL = 0; 
            double Z1 = 0;
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_z = -1 + offset_z;  var o_zw = -1 + offset_zw;  var o_vf = -1 + offset_vf; 
             var o_vfw = -1 + offset_vfw; var o_vl = -1 + offset_vl;  var o_vlw = -1 + offset_vlw; 
             var o_dsigma = -1 + offset_dsigma; var o_idx = -1 + offset_idx;  var o_idxp = -1 + offset_idxp; 
             var o_idxq = -1 + offset_idxq; var o_perm = -1 + offset_perm;  var o_givcol = -1 - LDGCOL + offset_givcol; 
             var o_givnum = -1 - LDGNUM + offset_givnum;
        ...
        LABEL80:;
            ...
            else
            {
                ...
                if (Math.Abs(D[J + o_d] - D[JPREV + o_d]) <= TOL)
                {
                    ...
                    _drot.Run(1, ref VF, JPREV + o_vf, 1, ref VF, J + o_vf, 1, C
                                   , S);
                    _drot.Run(1, ref VL, JPREV + o_vl, 1, ref VL, J + o_vl, 1, C
                                   , S);
                    K2 -= 1;
        ...
        LABEL100:;
            ...
            if (M > N)
            {
                ...
                _drot.Run(1, ref VF, M + o_vf, 1, ref VF, 1 + o_vf, 1, C
                               , S);
                _drot.Run(1, ref VL, M + o_vl, 1, ref VL, 1 + o_vl, 1, C
                               , S);
            }
            else
            {
            ...
            // *     Restore Z, VF, and VL.
            // *
            _dcopy.Run(K - 1, ZW, 2 + o_zw, 1, ref Z, 2 + o_z, 1);
            _dcopy.Run(N - 1, VFW, 2 + o_vfw, 1, ref VF, 2 + o_vf, 1);
            _dcopy.Run(N - 1, VLW, 2 + o_vlw, 1, ref VL, 2 + o_vl, 1);
            // *
            return;
            // *
            // *     End of DLASD7
