    ...
    public class DLATRZ
    {
                         ...
                         , ref double[] WORK, int offset_work)
        {
            ...
            for (I = M; I >= 1; I +=  - 1)
            {
                ...
                // *        [ A(i,i) A(i,n-l+1:n) ]
                // *
                _dlarfg.Run(L + 1, ref A[I+I * LDA + o_a], ref A, I+(N - L + 1) * LDA + o_a, LDA, ref TAU[I + o_tau]);
                // *
                // *        Apply H(i) to A(1:i-1,i:n) from the right
                // *
                _dlarz.Run("Right", I - 1, N - I + 1, L, A, I+(N - L + 1) * LDA + o_a, LDA
