...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGELQ2
    {
        ...
        public DGELQ2(DLARF dlarf, DLARFG dlarfg, XERBLA xerbla)
        {
                         ...
                         , ref int INFO)
        {
            ...
            for (I = 1; I <= K; I++)
            {
                ...
                // *
                _dlarfg.Run(N - I + 1, ref A[I+I * LDA + o_a], ref A, I+Math.Min(I + 1, N) * LDA + o_a, LDA, ref TAU[I + o_tau]);
                if (I < M)
                {
                    // *
                    ...
                    AII = A[I+I * LDA + o_a];
                    A[I+I * LDA + o_a] = ONE;
                    _dlarf.Run("Right", M - I, N - I + 1, A, I+I * LDA + o_a, LDA, TAU[I + o_tau]
