...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class ILAENV
    {
        ...
        var ilaenv = 0;
            ...
            var I = 0; var IC = 0; var IZ = 0; var NB = 0; var NBMIN = 0; var NX = 0; var CNAME = false; var SNAME = false; 
            var C1 = new string(' ', 1);var C2 = new string(' ', 2); var C4 = new string(' ', 2); 
            var C3 = new string(' ', 3);var SUBNAM = new string(' ', 6); 
        ...
        LABEL160:;
            ...
            // *
            ilaenv = _iparmq.Run(ISPEC, NAME, OPTS, N1, N2, N3, N4);
            return ilaenv;
            // *
            // *     End of ILAENV
            // *
