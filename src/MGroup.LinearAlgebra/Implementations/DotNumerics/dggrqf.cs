...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGGRQF
    {
        ...
        public DGGRQF(DGEQRF dgeqrf, DGERQF dgerqf, DORMRQ dormrq, XERBLA xerbla, ILAENV ilaenv)
        {
            ...
            _dgeqrf = dgeqrf; _dgerqf = dgerqf; _dormrq = dormrq; _xerbla = xerbla; _ilaenv = ilaenv; 
                         ...
                         , ref double[] B, int offset_b, int LDB, ref double[] TAUB, int offset_taub, ref double[] WORK, int offset_work, int LWORK, ref int INFO)
        {
            ...
            var LQUERY = false; var LOPT = 0; var LWKOPT = 0; var NB = 0; var NB1 = 0; var NB2 = 0; var NB3 = 0; 
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_taua = -1 + offset_taua;  var o_b = -1 - LDB + offset_b; 
             var o_taub = -1 + offset_taub; var o_work = -1 + offset_work; 
            ...
            INFO = 0;
            NB1 = _ilaenv.Run(1, "DGERQF", " ", M, N,  - 1,  - 1);
            NB2 = _ilaenv.Run(1, "DGEQRF", " ", P, N,  - 1,  - 1);
            NB3 = _ilaenv.Run(1, "DORMRQ", " ", M, N, P,  - 1);
            ...
            // *
            _dgerqf.Run(M, N, ref A, offset_a, LDA, ref TAUA, offset_taua, ref WORK, offset_work
                             , LWORK, ref INFO);
            LOPT = (int)WORK[1 + o_work];
            // *
            // *     Update B := B*Q'
            // *
            _dormrq.Run("Right", "Transpose", P, N, Math.Min(M, N), ref A, Math.Max(1, M - N + 1)+1 * LDA + o_a
            ...
            // *
            _dgeqrf.Run(P, N, ref B, offset_b, LDB, ref TAUB, offset_taub, ref WORK, offset_work
                             , LWORK, ref INFO);
