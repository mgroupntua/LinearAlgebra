...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAED9
    {
        ...
        public DLAED9(DLAMC3 dlamc3, DNRM2 dnrm2, DCOPY dcopy, DLAED4 dlaed4, XERBLA xerbla)
        {
            ...
            _dlamc3 = dlamc3; _dnrm2 = dnrm2; _dcopy = dcopy; _dlaed4 = dlaed4; _xerbla = xerbla; 
                         ...
                         , ref int INFO)
        {
            ...
            var S_I = 0; var Q_I = 0; var Q_J = 0; var S_J = 0; 
            ...
            #region Array Index Correction
             ...
             var o_w = -1 + offset_w; var o_s = -1 - LDS + offset_s; 
            ...
            for (J = 1; J <= K; J++)
            {
                ...
                TEMP = _dnrm2.Run(K, Q, 1+J * LDQ + o_q, 1);
                S_J = J * LDS + o_s;
                Q_J = J * LDQ + o_q;
                for (I = 1; I <= K; I++)
                {
