    ...
    public class DGERQ2
    {
                         ...
                         , ref int INFO)
        {
            ...
            for (I = K; I >= 1; I +=  - 1)
            {
                ...
                // *        A(m-k+i,1:n-k+i-1)
                // *
                _dlarfg.Run(N - K + I, ref A[M - K + I+(N - K + I) * LDA + o_a], ref A, M - K + I+1 * LDA + o_a, LDA, ref TAU[I + o_tau]);
                // *
                // *        Apply H(i) to A(1:m-k+i-1,1:n-k+i) from the right
                // *
                AII = A[M - K + I+(N - K + I) * LDA + o_a];
                A[M - K + I+(N - K + I) * LDA + o_a] = ONE;
                _dlarf.Run("Right", M - K + I - 1, N - K + I, A, M - K + I+1 * LDA + o_a, LDA, TAU[I + o_tau]
