...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASR
    {
                         ...
                         , double[] S, int offset_s, ref double[] A, int offset_a, int LDA)
        {
            ...
            var I = 0; var INFO = 0; var J = 0; double CTEMP = 0; double STEMP = 0; double TEMP = 0; 
            ...
            var A_0 = 0; var A_1 = 0; var A_J = 0; var A_2 = 0; var A_3 = 0; var A_N = 0; 
            ...
            #region Array Index Correction
             ...
             var o_c = -1 + offset_c;  var o_s = -1 + offset_s;  var o_a = -1 - LDA + offset_a; 
            ...
            INFO = 0;
            if (!(_lsame.Run(SIDE, "L") || _lsame.Run(SIDE, "R")))
            {
                INFO = 1;
            }
            else
            {
                if (!(_lsame.Run(PIVOT, "V") || _lsame.Run(PIVOT, "T") || _lsame.Run(PIVOT, "B")))
                {
                    INFO = 2;
                }
                else
                {
                    if (!(_lsame.Run(DIRECT, "F") || _lsame.Run(DIRECT, "B")))
                    {
                        INFO = 3;
                    }
                    else
