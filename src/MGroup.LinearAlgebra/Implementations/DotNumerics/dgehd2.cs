    ...
    public class DGEHD2
    {
                         ...
                         , ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            for (I = ILO; I <= IHI - 1; I++)
            {
                ...
                // *
                _dlarfg.Run(IHI - I, ref A[I + 1+I * LDA + o_a], ref A, Math.Min(I + 2, N)+I * LDA + o_a, 1, ref TAU[I + o_tau]);
                AII = A[I + 1+I * LDA + o_a];
                A[I + 1+I * LDA + o_a] = ONE;
                // *
                // *        Apply H(i) to A(1:ihi,i+1:ihi) from the right
                // *
                _dlarf.Run("Right", IHI, IHI - I, A, I + 1+I * LDA + o_a, 1, TAU[I + o_tau]
                                , ref A, 1+(I + 1) * LDA + o_a, LDA, ref WORK, offset_work);
                // *
                // *        Apply H(i) to A(i+1:ihi,i+1:n) from the left
                // *
                _dlarf.Run("Left", IHI - I, N - I, A, I + 1+I * LDA + o_a, 1, TAU[I + o_tau]
