...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLARFX
    {
        ...
        public DLARFX(LSAME lsame, DGEMV dgemv, DGER dger)
        {
            ...
            _lsame = lsame; _dgemv = dgemv; _dger = dger; 
                         ...
                         , int LDC, ref double[] WORK, int offset_work)
        {
            ...
            var J = 0; double SUM = 0; double T1 = 0; double T10 = 0; double T2 = 0; double T3 = 0; double T4 = 0; double T5 = 0; 
            ...
            var C_1 = 0; var C_2 = 0; var C_3 = 0; var C_4 = 0; var C_5 = 0; var C_6 = 0; var C_7 = 0; var C_8 = 0; var C_9 = 0; 
            var C_10 = 0;
            ...
            if (_lsame.Run(SIDE, "L"))
            {
                ...
                // *        w := C'*v
                // *
                _dgemv.Run("Transpose", M, N, ONE, C, offset_c, LDC
                                , V, offset_v, 1, ZERO, ref WORK, offset_work, 1);
                // *
                // *        C := C - tau * v * w'
                // *
                _dger.Run(M, N,  - TAU, V, offset_v, 1, WORK, offset_work
            ...
            else
            {
                ...
                // *        w := C * v
                // *
                _dgemv.Run("No transpose", M, N, ONE, C, offset_c, LDC
                                , V, offset_v, 1, ZERO, ref WORK, offset_work, 1);
                // *
                // *        C := C - tau * w * v'
                // *
                _dger.Run(M, N,  - TAU, WORK, offset_work, 1, V, offset_v
                               , 1, ref C, offset_c, LDC);
                goto LABEL410;
            LABEL210:;
                // *
