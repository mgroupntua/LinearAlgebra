...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAED4
    {
        ...
        public DLAED4(DLAMCH dlamch, DLAED5 dlaed5, DLAED6 dlaed6)
        {
            ...
            _dlamch = dlamch; _dlaed5 = dlaed5; _dlaed6 = dlaed6; 
                         ...
                         , ref double DLAM, ref int INFO)
        {
            ...
            var ITER = 0;var J = 0; var NITER = 0; double A = 0; double B = 0; double C = 0; double DEL = 0; double DLTLB = 0; 
            ...
            double TEMP1 = 0;double W = 0; var offset_zz = 0; var o_zz = -1; 
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_z = -1 + offset_z;  var o_delta = -1 + offset_delta; 
            ...
            if (N == 2)
            {
                _dlaed5.Run(I, D, offset_d, Z, offset_z, ref DELTA, offset_delta, RHO, ref DLAM);
                return;
            }
            // *
            ...
            else
            {
                ...
                else
                {
                    ...
                    _dlaed6.Run(NITER, ORGATI, C, DELTA, IIM1 + o_delta, ZZ, offset_zz, W
                                     , ref ETA, ref INFO);
