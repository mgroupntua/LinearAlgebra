...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAQR4
    {
        ...
        public DLAQR4(ILAENV ilaenv, DLACPY dlacpy, DLAHQR dlahqr, DLANV2 dlanv2, DLAQR2 dlaqr2, DLAQR5 dlaqr5)
        {
            ...
            _ilaenv = ilaenv; _dlacpy = dlacpy; _dlahqr = dlahqr; _dlanv2 = dlanv2; _dlaqr2 = dlaqr2; 
            _dlaqr5 = dlaqr5;
                         ...
                         , int LDZ, ref double[] WORK, int offset_work, int LWORK, ref int INFO)
        {
            ...
            else
            {
                ...
                // *        .    NWR.GE.3.) ====
                // *
                NWR = _ilaenv.Run(13, "DLAQR4", JBCMPZ, N, ILO, IHI, LWORK);
                NWR = Math.Max(2, NWR);
                ...
                // *
                NSR = _ilaenv.Run(15, "DLAQR4", JBCMPZ, N, ILO, IHI, LWORK);
                ...
                // *
                _dlaqr2.Run(WANTT, WANTZ, N, ILO, IHI, NWR + 1
                ...
                // *
                NMIN = _ilaenv.Run(12, "DLAQR4", JBCMPZ, N, ILO, IHI, LWORK);
                NMIN = Math.Max(NTINY, NMIN);
                // *
                // *        ==== Nibble crossover point ====
                // *
                NIBBLE = _ilaenv.Run(14, "DLAQR4", JBCMPZ, N, ILO, IHI, LWORK);
                NIBBLE = Math.Max(0, NIBBLE);
                // *
                // *        ==== Accumulate reflections during ttswp?  Use block
                // *        .    2-by-2 structure during matrix-matrix multiply? ====
                // *
                KACC22 = _ilaenv.Run(16, "DLAQR4", JBCMPZ, N, ILO, IHI, LWORK);
                ...
                LABEL20:;
                    ...
                    // *           ==== Aggressive early deflation ====
                    // *
                    _dlaqr2.Run(WANTT, WANTZ, N, KTOP, KBOT, NW
                                     , ref H, offset_h, LDH, ILOZ, IHIZ, ref Z, offset_z, LDZ
