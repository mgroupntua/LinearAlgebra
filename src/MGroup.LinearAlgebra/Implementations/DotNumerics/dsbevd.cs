...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DSBEVD
    {
                      ...
                      , XERBLA xerbla)
        {
            ...
            _lsame = lsame; _dlamch = dlamch; _dlansb = dlansb; _dgemm = dgemm; _dlacpy = dlacpy; 
            _dlascl = dlascl;_dsbtrd = dsbtrd; _dscal = dscal; _dstedc = dstedc; _dsterf = dsterf; 
            _xerbla = xerbla;
                         ...
                         , int LIWORK, ref int INFO)
        {
            ...
            var LOWER = false; var LQUERY = false; var WANTZ = false; var IINFO = 0; var INDE = 0; var INDWK2 = 0; 
            var INDWRK = 0;var ISCALE = 0; var LIWMIN = 0; var LLWRK2 = 0; var LWMIN = 0; double ANRM = 0; double BIGNUM = 0; 
            ...
            else
            {
                ...
                _dgemm.Run("N", "N", N, N, N, ONE
                                , Z, offset_z, LDZ, WORK, INDWRK + o_work, N, ZERO, ref WORK, INDWK2 + o_work
                                , N);
                _dlacpy.Run("A", N, N, WORK, INDWK2 + o_work, N, ref Z, offset_z
                                 , LDZ);
            }
            // *
