...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLANST
    {
        ...
        double dlanst = 0;
            ...
            var I = 0; double ANORM = 0; double SCALE = 0; double SUM = 0; 
            ...
            else
            {
                ...
                {
                    if (_lsame.Run(NORM, "O") || NORM == "1" || _lsame.Run(NORM, "I"))
                    {
                        // *
                        // *        Find norm1(A).
                        // *
                    ...
                    else
                    {
                        if (_lsame.Run(NORM, "F") || _lsame.Run(NORM, "E"))
                        {
                            ...
                            if (N > 1)
                            {
                                _dlassq.Run(N - 1, E, offset_e, 1, ref SCALE, ref SUM);
                                SUM *= 2;
                            }
                            _dlassq.Run(N, D, offset_d, 1, ref SCALE, ref SUM);
