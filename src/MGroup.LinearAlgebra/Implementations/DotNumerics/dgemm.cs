...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGEMM
    {
                         ...
                         , int LDC)
        {
            ...
            double TEMP = 0; var I = 0; var INFO = 0; var J = 0; var L = 0; var NCOLA = 0; var NROWA = 0; var NROWB = 0; 
            var NOTA = false;var NOTB = false; 
            ...
            var C_J = 0; var A_L = 0; var A_I = 0; var B_J = 0; 
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_b = -1 - LDB + offset_b;  var o_c = -1 - LDC + offset_c; 
            ...
            NOTA = _lsame.Run(TRANSA, "N");
            NOTB = _lsame.Run(TRANSB, "N");
            if (NOTA)
            {
                NROWA = M;
                NCOLA = K;
            ...
            // *
            INFO = 0;
            if (!NOTA && !_lsame.Run(TRANSA, "C") && !_lsame.Run(TRANSA, "T"))
            {
                INFO = 1;
            }
            else
            {
                if (!NOTB && !_lsame.Run(TRANSB, "C") && !_lsame.Run(TRANSB, "T"))
                {
                    INFO = 2;
                }
                else
