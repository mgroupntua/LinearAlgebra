...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAHQR
    {
        ...
        public DLAHQR(DLAMCH dlamch, DCOPY dcopy, DLABAD dlabad, DLANV2 dlanv2, DLARFG dlarfg, DROT drot)
        {
			...
			_dlamch = dlamch; _dcopy = dcopy; _dlabad = dlabad; _dlanv2 = dlanv2; _dlarfg = dlarfg;
			_drot = drot;
                         ...
                         , int LDZ, ref int INFO)
        {
            ...
            double ULP = 0;double V2 = 0; double V3 = 0; var I = 0; var I1 = 0; var I2 = 0; var ITS = 0; var J = 0; var K = 0; 
            var L = 0;var M = 0; var NH = 0; var NR = 0; var NZ = 0; var offset_v = 0; var o_v = -1; 
            ...
            var H_K = 0; var H_0 = 0; var H_1 = 0; var H_2 = 0; var H_3 = 0; var Z_K = 0; var Z_0 = 0; var Z_1 = 0; var Z_2 = 0; 
            var Z_3 = 0;var H_4 = 0; var H_5 = 0; var Z_4 = 0; var Z_5 = 0; 
        ...
        LABEL20:;
            ...
            LABEL60:;
                ...
                for (K = M; K <= I - 1; K++)
                {
                    ...
                    // *
                    NR = Math.Min(3, I - K + 1);
                    if (K > M) _dcopy.Run(NR, H, K+(K - 1) * LDH + o_h, 1, ref V, offset_v, 1);
					_dlarfg.Run(NR, ref V[1 + o_v], ref V, 2 + o_v, 1, ref T1);
                    if (K > M)
                    {
        ...
        LABEL150:;
            ...
            else
            {
                if (L == I - 1)
                {
					...
					// *
					_dlanv2.Run(ref H[I - 1+(I - 1) * LDH + o_h], ref H[I - 1+I * LDH + o_h], ref H[I+(I - 1) * LDH + o_h], ref H[I+I * LDH + o_h], ref WR[I - 1 + o_wr], ref WI[I - 1 + o_wi]
                    ...
                    if (WANTT)
                    {
                        ...
                        if (I2 > I)
                        {
							_drot.Run(I2 - I, ref H, I - 1+(I + 1) * LDH + o_h, LDH, ref H, I+(I + 1) * LDH + o_h, LDH, CS
                                           , SN);
                        }
						_drot.Run(I - I1 - 1, ref H, I1+(I - 1) * LDH + o_h, 1, ref H, I1+I * LDH + o_h, 1, CS
                                       , SN);
                    }
                    if (WANTZ)
                    {
						...
						// *
						_drot.Run(NZ, ref Z, ILOZ+(I - 1) * LDZ + o_z, 1, ref Z, ILOZ+I * LDZ + o_z, 1, CS
                                       , SN);
                    }
                }
            }
