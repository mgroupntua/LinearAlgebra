...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASD6
    {
        ...
        public DLASD6(DCOPY dcopy, DLAMRG dlamrg, DLASCL dlascl, DLASD7 dlasd7, DLASD8 dlasd8, XERBLA xerbla)
        {
            ...
            _dcopy = dcopy; _dlamrg = dlamrg; _dlascl = dlascl; _dlasd7 = dlasd7; _dlasd8 = dlasd8; 
            _xerbla = xerbla;
                         ...
                         , ref int[] IWORK, int offset_iwork, ref int INFO)
        {
            ...
            var I = 0; var IDX = 0; var IDXC = 0; var IDXP = 0; var ISIGMA = 0; var IVFW = 0; var IVLW = 0; var IW = 0; var M = 0; 
            var N = 0;var N1 = 0; var N2 = 0; double ORGNRM = 0; 
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_vf = -1 + offset_vf;  var o_vl = -1 + offset_vl;  var o_idxq = -1 + offset_idxq; 
             var o_perm = -1 + offset_perm; var o_givcol = -1 - LDGCOL + offset_givcol; 
             var o_givnum = -1 - LDGNUM + offset_givnum; var o_poles = -1 - LDGNUM + offset_poles;  var o_difl = -1 + offset_difl; 
             var o_difr = -1 + offset_difr; var o_z = -1 + offset_z;  var o_work = -1 + offset_work; 
            ...
            // *
            _dlasd7.Run(ICOMPQ, NL, NR, SQRE, ref K, ref D, offset_d
            ...
            // *
            _dlasd8.Run(ICOMPQ, K, ref D, offset_d, ref Z, offset_z, ref VF, offset_vf, ref VL, offset_vl
            ...
            if (ICOMPQ == 1)
            {
                _dcopy.Run(K, D, offset_d, 1, ref POLES, 1+1 * LDGNUM + o_poles, 1);
                _dcopy.Run(K, WORK, ISIGMA + o_work, 1, ref POLES, 1+2 * LDGNUM + o_poles, 1);
            }
            // *
            // *     Unscale.
            // *
            ...
            N1 = K;
            N2 = N - K;
            _dlamrg.Run(N1, N2, D, offset_d, 1,  - 1, ref IDXQ, offset_idxq);
            // *
            return;
            // *
            // *     End of DLASD6
