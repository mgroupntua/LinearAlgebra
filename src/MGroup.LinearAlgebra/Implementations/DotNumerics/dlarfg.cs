...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLARFG
    {
        ...
        public DLARFG(DLAMCH dlamch, DLAPY2 dlapy2, DNRM2 dnrm2, DSCAL dscal)
        {
            ...
            _dlamch = dlamch; _dlapy2 = dlapy2; _dnrm2 = dnrm2; _dscal = dscal; 
        ...
        public void Run(int N, ref double ALPHA, ref double[] X, int offset_x, int INCX, ref double TAU)
        {
            ...
            var J = 0; var KNT = 0; double BETA = 0; double RSAFMN = 0; double SAFMIN = 0; double XNORM = 0; 
            ...
            // *
            XNORM = _dnrm2.Run(N - 1, X, offset_x, INCX);
            // *
            if (XNORM == ZERO)
            {
                // *
            ...
            else
            {
                ...
                // *        general case
                // *
                BETA =  - FortranLib.Sign(_dlapy2.Run(ALPHA, XNORM),ALPHA);
                SAFMIN = _dlamch.Run("S") / _dlamch.Run("E");
                ...
                LABEL10:;
                    KNT += 1;
                    _dscal.Run(N - 1, RSAFMN, ref X, offset_x, INCX);
                    BETA *= RSAFMN;
                    ALPHA *= RSAFMN;
                    ...
                    BETA =  - FortranLib.Sign(_dlapy2.Run(ALPHA, XNORM),ALPHA);
                    TAU = (BETA - ALPHA) / BETA;
                    _dscal.Run(N - 1, ONE / (ALPHA - BETA), ref X, offset_x, INCX);
                    // *
