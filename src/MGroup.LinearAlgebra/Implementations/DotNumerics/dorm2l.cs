...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORM2L
    {
        ...
        public DORM2L(LSAME lsame, DLARF dlarf, XERBLA xerbla)
        {
    

            #region Set Dependencies
            
            _lsame = lsame; _dlarf = dlarf; _xerbla = xerbla; 
                         ...
                         , int LDA, double[] TAU, int offset_tau, ref double[] C, int offset_c, int LDC, ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            var LEFT = false; var NOTRAN = false; var I = 0; var I1 = 0; var I2 = 0; var I3 = 0; var MI = 0; var NI = 0; 
            var NQ = 0;double AII = 0; 
            ...
            for (I = I1; I3 >= 0 ? I <= I2 : I >= I2; I += I3)
            {
                ...
                // *        Apply H(i)
                // *
                AII = A[NQ - K + I+I * LDA + o_a];
                A[NQ - K + I+I * LDA + o_a] = ONE;
                _dlarf.Run(SIDE, MI, NI, A, 1+I * LDA + o_a, 1, TAU[I + o_tau]
                                , ref C, offset_c, LDC, ref WORK, offset_work);
                A[NQ - K + I+I * LDA + o_a] = AII;
            }
            return;
            // *
            // *     End of DORM2L
