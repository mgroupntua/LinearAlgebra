...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLALSA
    {
        ...
        public DLALSA(DCOPY dcopy, DGEMM dgemm, DLALS0 dlals0, DLASDT dlasdt, XERBLA xerbla)
        {
            ...
            _dcopy = dcopy; _dgemm = dgemm; _dlals0 = dlals0; _dlasdt = dlasdt; _xerbla = xerbla; 
                         ...
                         , ref int[] IWORK, int offset_iwork, ref int INFO)
        {
            ...
            var I = 0; var I1 = 0; var IC = 0; var IM1 = 0; var INODE = 0; var J = 0; var LF = 0; var LL = 0; var LVL = 0; 
            var LVL2 = 0;var ND = 0; var NDB1 = 0; var NDIML = 0; var NDIMR = 0; var NL = 0; var NLF = 0; var NLP1 = 0; 
            var NLVL = 0;var NR = 0; var NRF = 0; var NRP1 = 0; var SQRE = 0; 
            ...
            #region Array Index Correction
             ...
             var o_b = -1 - LDB + offset_b;  var o_bx = -1 - LDBX + offset_bx;  var o_u = -1 - LDU + offset_u; 
             var o_vt = -1 - LDU + offset_vt; var o_k = -1 + offset_k;  var o_difl = -1 - LDU + offset_difl; 
             var o_difr = -1 - LDU + offset_difr; var o_z = -1 - LDU + offset_z;  var o_poles = -1 - LDU + offset_poles; 
             var o_givptr = -1 + offset_givptr; var o_givcol = -1 - LDGCOL + offset_givcol; 
             var o_perm = -1 - LDGCOL + offset_perm; var o_givnum = -1 - LDU + offset_givnum;  var o_c = -1 + offset_c; 
             var o_s = -1 + offset_s; var o_work = -1 + offset_work;  var o_iwork = -1 + offset_iwork; 
            ...
            for (I = 1; I <= ND; I++)
            {
                ...
                _dcopy.Run(NRHS, B, IC+1 * LDB + o_b, LDB, ref BX, IC+1 * LDBX + o_bx, LDBX);
            }
            // *
            ...
            for (LVL = NLVL; LVL >= 1; LVL +=  - 1)
            {
                ...
                for (I = LF; I <= LL; I++)
                {
                    ...
                    NRF = IC + 1;
                    J -= 1;
                    _dlals0.Run(ICOMPQ, NL, NR, SQRE, NRHS, ref BX, NLF+1 * LDBX + o_bx
        ...
        LABEL50:;
            ...
            for (LVL = 1; LVL <= NLVL; LVL++)
            {
                ...
                for (I = LL; I >= LF; I +=  - 1)
                {
                    ...
                    J += 1;
                    _dlals0.Run(ICOMPQ, NL, NR, SQRE, NRHS, ref B, NLF+1 * LDB + o_b
