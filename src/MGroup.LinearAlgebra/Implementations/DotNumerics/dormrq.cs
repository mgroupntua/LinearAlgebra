...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORMRQ
    {
        ...
        LSAME _lsame; ILAENV _ilaenv; DLARFB _dlarfb; DLARFT _dlarft; DORMR2 _dormr2; XERBLA _xerbla; 
        ...
        public DORMRQ(LSAME lsame, ILAENV ilaenv, DLARFB dlarfb, DLARFT dlarft, DORMR2 dormr2, XERBLA xerbla)
        {
    

            #region Set Dependencies
            
            _lsame = lsame; _ilaenv = ilaenv; _dlarfb = dlarfb; _dlarft = dlarft; _dormr2 = dormr2; 
            _xerbla = xerbla;
                         ...
                         , ref int INFO)
        {
            ...
            var I1 = 0;var I2 = 0; var I3 = 0; var IB = 0; var IINFO = 0; var IWS = 0; var LDWORK = 0; var LWKOPT = 0; var MI = 0; 
            var NB = 0;var NBMIN = 0; var NI = 0; var NQ = 0; var NW = 0; var offset_t = 0;
            ...
            if (NB < NBMIN || NB >= K)
            {
                ...
                // *        Use unblocked code
                // *
                _dormr2.Run(SIDE, TRANS, M, N, K, ref A, offset_a
            ...
            else
            {
                ...
                for (I = I1; I3 >= 0 ? I <= I2 : I >= I2; I += I3)
                {
                    ...
                    // *
                    _dlarft.Run("Backward", "Rowwise", NQ - K + I + IB - 1, IB, ref A, I+1 * LDA + o_a, LDA
                    ...
                    // *           Apply H or H'
                    // *
                    _dlarfb.Run(SIDE, TRANST, "Backward", "Rowwise", MI, NI
                                     , IB, A, I+1 * LDA + o_a, LDA, T, offset_t, LDT, ref C, offset_c
