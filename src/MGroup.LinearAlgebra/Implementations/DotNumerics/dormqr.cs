...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORMQR
    {
        ...
        public DORMQR(LSAME lsame, ILAENV ilaenv, DLARFB dlarfb, DLARFT dlarft, DORM2R dorm2r, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _ilaenv = ilaenv; _dlarfb = dlarfb; _dlarft = dlarft; _dorm2r = dorm2r; 
            _xerbla = xerbla;
                         ...
                         , ref int INFO)
        {
            ...
            var IB = 0;var IC = 0; var IINFO = 0; var IWS = 0; var JC = 0; var LDWORK = 0; var LWKOPT = 0; var MI = 0; var NB = 0; 
            var NBMIN = 0;var NI = 0; var NQ = 0; var NW = 0; var offset_t = 0;
            ...
            if (INFO == 0)
            {
                ...
                // *
                NB = Math.Min(NBMAX, _ilaenv.Run(1, "DORMQR", SIDE + TRANS, M, N, K,  - 1));
            ...
            if (NB > 1 && NB < K)
            {
                ...
                {
                    NB = LWORK / LDWORK;
                    NBMIN = Math.Max(2, _ilaenv.Run(2, "DORMQR", SIDE + TRANS, M, N, K,  - 1));
                }
            }
            else
            {
            ...
            if (NB < NBMIN || NB >= K)
            {
                ...
                // *        Use unblocked code
                // *
                _dorm2r.Run(SIDE, TRANS, M, N, K, ref A, offset_a
            ...
            else
            {
                ...
                for (I = I1; I3 >= 0 ? I <= I2 : I >= I2; I += I3)
                {
                    ...
                    // *
                    _dlarft.Run("Forward", "Columnwise", NQ - I + 1, IB, ref A, I+I * LDA + o_a, LDA
                    ...
                    // *           Apply H or H'
                    // *
                    _dlarfb.Run(SIDE, TRANS, "Forward", "Columnwise", MI, NI
