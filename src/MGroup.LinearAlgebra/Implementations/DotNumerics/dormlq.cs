...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DORMLQ
    {
        ...
        LSAME _lsame; ILAENV _ilaenv; DLARFB _dlarfb; DLARFT _dlarft; DORML2 _dorml2; XERBLA _xerbla; 
        ...
        public DORMLQ(LSAME lsame, ILAENV ilaenv, DLARFB dlarfb, DLARFT dlarft, DORML2 dorml2, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _ilaenv = ilaenv; _dlarfb = dlarfb; _dlarft = dlarft; _dorml2 = dorml2; 
            _xerbla = xerbla;
                         ...
                         , ref int INFO)
        {
            ...
            var I1 = 0;var I2 = 0; var I3 = 0; var IB = 0; var IC = 0; var IINFO = 0; var IWS = 0; var JC = 0; var LDWORK = 0; 
            var LWKOPT = 0;var MI = 0; var NB = 0; var NBMIN = 0; var NI = 0; var NQ = 0; var NW = 0; 
            var offset_t = 0;
            ...
            if (INFO == 0)
            {
                ...
                // *
                NB = Math.Min(NBMAX, _ilaenv.Run(1, "DORMLQ", SIDE + TRANS, M, N, K,  - 1));
            ...
            if (NB > 1 && NB < K)
            {
                ...
                {
                    NB = LWORK / LDWORK;
                    NBMIN = Math.Max(2, _ilaenv.Run(2, "DORMLQ", SIDE + TRANS, M, N, K,  - 1));
                }
            }
            else
            {
            ...
            if (NB < NBMIN || NB >= K)
            {
                ...
                // *        Use unblocked code
                // *
                _dorml2.Run(SIDE, TRANS, M, N, K, ref A, offset_a
            ...
            else
            {
                ...
                for (I = I1; I3 >= 0 ? I <= I2 : I >= I2; I += I3)
                {
                    ...
                    // *
                    _dlarft.Run("Forward", "Rowwise", NQ - I + 1, IB, ref A, I+I * LDA + o_a, LDA
                    ...
                    // *           Apply H or H'
                    // *
                    _dlarfb.Run(SIDE, TRANST, "Forward", "Rowwise", MI, NI
