...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAQR0
    {
        ...
        ILAENV _ilaenv; DLACPY _dlacpy; DLAHQR _dlahqr; DLANV2 _dlanv2; DLAQR3 _dlaqr3; DLAQR4 _dlaqr4; DLAQR5 _dlaqr5; 
        ...
        public DLAQR0(ILAENV ilaenv, DLACPY dlacpy, DLAHQR dlahqr, DLANV2 dlanv2, DLAQR3 dlaqr3, DLAQR4 dlaqr4, DLAQR5 dlaqr5)
        {
            ...
            _ilaenv = ilaenv; _dlacpy = dlacpy; _dlahqr = dlahqr; _dlanv2 = dlanv2; _dlaqr3 = dlaqr3; 
            _dlaqr4 = dlaqr4;_dlaqr5 = dlaqr5; 
                         ...
                         , int LDZ, ref double[] WORK, int offset_work, int LWORK, ref int INFO)
        {
            ...
            double SWAP = 0;var I = 0; var INF = 0; var IT = 0; var ITMAX = 0; var K = 0; var KACC22 = 0; var KBOT = 0; 
            var KDU = 0;var KS = 0; var KT = 0; var KTOP = 0; var KU = 0; var KV = 0; var KWH = 0; var KWTOP = 0; var KWV = 0; 
            var LD = 0;var LS = 0; var LWKOPT = 0; var NDFL = 0; var NH = 0; var NHO = 0; var NIBBLE = 0; var NMIN = 0; 
            var NS = 0;var NSMAX = 0; var NSR = 0; var NVE = 0; var NW = 0; var NWMAX = 0; var NWR = 0; var NWINC = false; 
            var SORTED = false;var JBCMPZ = new string(' ', 2); var offset_zdum = 0; 
            ...
            else
            {
                ...
                // *        .    NWR.GE.3.) ====
                // *
                NWR = _ilaenv.Run(13, "DLAQR0", JBCMPZ, N, ILO, IHI, LWORK);
                NWR = Math.Max(2, NWR);
                ...
                // *
                NSR = _ilaenv.Run(15, "DLAQR0", JBCMPZ, N, ILO, IHI, LWORK);
                ...
                // *
                _dlaqr3.Run(WANTT, WANTZ, N, ILO, IHI, NWR + 1
                ...
                // *
                NMIN = _ilaenv.Run(12, "DLAQR0", JBCMPZ, N, ILO, IHI, LWORK);
                NMIN = Math.Max(NTINY, NMIN);
                // *
                // *        ==== Nibble crossover point ====
                // *
                NIBBLE = _ilaenv.Run(14, "DLAQR0", JBCMPZ, N, ILO, IHI, LWORK);
                NIBBLE = Math.Max(0, NIBBLE);
                // *
                // *        ==== Accumulate reflections during ttswp?  Use block
                // *        .    2-by-2 structure during matrix-matrix multiply? ====
                // *
                KACC22 = _ilaenv.Run(16, "DLAQR0", JBCMPZ, N, ILO, IHI, LWORK);
                ...
                LABEL20:;
                    ...
                    // *           ==== Aggressive early deflation ====
                    // *
                    _dlaqr3.Run(WANTT, WANTZ, N, KTOP, KBOT, NW
                                     , ref H, offset_h, LDH, ILOZ, IHIZ, ref Z, offset_z, LDZ
                    ...
                    if (LD == 0 || 100 * LD <= NW * NIBBLE && KBOT - KTOP + 1 > Math.Min(NMIN, NWMAX))
                    {
                        ...
                        if (FortranLib.Mod(NDFL,KEXSH) == 0)
                        {
                            ...
                            for (I = KBOT; I >= Math.Max(KS + 1, KTOP + 2); I +=  - 2)
                            {
                                ...
                                CC = WILK2 * SS;
                                DD = AA;
                                _dlanv2.Run(ref AA, ref BB, ref CC, ref DD, ref WR[I - 1 + o_wr], ref WI[I - 1 + o_wi]
                        ...
                        else
                        {
                            ...
                            if (KBOT - KS + 1 <= NS / 2)
                            {
                                KS = KBOT - NS + 1;
                                KT = N - NS + 1;
                                _dlacpy.Run("A", NS, NS, H, KS+KS * LDH + o_h, LDH, ref H, KT+1 * LDH + o_h
                                                 , LDH);
                                if (NS > NMIN)
                                {
                                    _dlaqr4.Run(false, false, NS, 1, NS, ref H, KT+1 * LDH + o_h
                                                     , LDH, ref WR, KS + o_wr, ref WI, KS + o_wi, 1, 1, ref ZDUM, offset_zdum
                                                     , 1, ref WORK, offset_work, LWORK, ref INF);
                                }
                                else
                                {
                                    _dlahqr.Run(false, false, NS, 1, NS, ref H, KT+1 * LDH + o_h
                                                     , LDH, ref WR, KS + o_wr, ref WI, KS + o_wi, 1, 1, ref ZDUM, offset_zdum
                                                     , 1, ref INF);
                                }
                                KS += INF;
                                ...
                                if (KS >= KBOT)
                                {
                                    ...
                                    _dlanv2.Run(ref AA, ref BB, ref CC, ref DD, ref WR[KBOT - 1 + o_wr], ref WI[KBOT - 1 + o_wi]
                        ...
                        // *              ==== Small-bulge multi-shift QR sweep ====
                        // *
                        _dlaqr5.Run(WANTT, WANTZ, KACC22, N, KTOP, KBOT
