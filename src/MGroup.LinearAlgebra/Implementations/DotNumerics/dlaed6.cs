...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLAED6
    {
                         ...
                         , ref double TAU, ref int INFO)
        {
            ...
            var o_dscale = -1; var o_zscale = -1; var SCALE = false; var I = 0; 
            var ITER = 0;var NITER = 0; double A = 0; double B = 0; double BASE = 0; double C = 0; double DDF = 0; double DF = 0; 
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_z = -1 + offset_z; 
            ...
            BASE = _dlamch.Run("Base");
            SMALL1 = Math.Pow(BASE,Convert.ToInt32(Math.Truncate(Math.Log(_dlamch.Run("SafMin")) / Math.Log(BASE) / THREE)));
            SMINV1 = ONE / SMALL1;
