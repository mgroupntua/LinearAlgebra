...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASD1
    {
        ...
        public DLASD1(DLAMRG dlamrg, DLASCL dlascl, DLASD2 dlasd2, DLASD3 dlasd3, XERBLA xerbla)
        {
            ...
            _dlamrg = dlamrg; _dlascl = dlascl; _dlasd2 = dlasd2; _dlasd3 = dlasd3; _xerbla = xerbla; 
                         ...
                         , ref double[] WORK, int offset_work, ref int INFO)
        {
            ...
            var COLTYP = 0; var I = 0; var IDX = 0; var IDXC = 0; var IDXP = 0; var IQ = 0; var ISIGMA = 0; var IU2 = 0; 
            var IVT2 = 0;var IZ = 0; var K = 0; var LDQ = 0; var LDU2 = 0; var LDVT2 = 0; var M = 0; var N = 0; var N1 = 0; 
            var N2 = 0;double ORGNRM = 0; 
            ...
            #region Array Index Correction
             ...
             var o_d = -1 + offset_d;  var o_u = -1 - LDU + offset_u;  var o_vt = -1 - LDVT + offset_vt; 
             var o_idxq = -1 + offset_idxq; var o_iwork = -1 + offset_iwork;  var o_work = -1 + offset_work; 
            ...
            // *
            _dlasd2.Run(NL, NR, SQRE, ref K, ref D, offset_d, ref WORK, IZ + o_work
            ...
            // *
            LDQ = K;
            _dlasd3.Run(NL, NR, SQRE, K, ref D, offset_d, ref WORK, IQ + o_work
