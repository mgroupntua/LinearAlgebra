...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGBSV
    {
        ...
        public DGBSV(DGBTRF dgbtrf, DGBTRS dgbtrs, XERBLA xerbla)
        {
            ...
            _dgbtrf = dgbtrf; _dgbtrs = dgbtrs; _xerbla = xerbla; 
        ...
        public DGBSV()
        {
            ...
            var dgbtrf = new DGBTRF(idamax, ilaenv, dcopy, dgbtf2, dgemm, dger, dlaswp, dscal, dswap, dtrsm
                                       , xerbla);
            var dgemv = new DGEMV(lsame, xerbla);
            var dtbsv = new DTBSV(lsame, xerbla);
            var dgbtrs = new DGBTRS(lsame, dgemv, dger, dswap, dtbsv, xerbla);
                         ...
                         , ref int[] IPIV, int offset_ipiv, ref double[] B, int offset_b, int LDB, ref int INFO)
        {
            ...
            if (INFO != 0)
            {
                _xerbla.Run("DGBSV ",  - INFO);
                return;
            }
            // *
            // *     Compute the LU factorization of the band matrix A.
            // *
            _dgbtrf.Run(N, N, KL, KU, ref AB, offset_ab, LDAB
            ...
            if (INFO == 0)
            {
                ...
                // *
                _dgbtrs.Run("No transpose", N, KL, KU, NRHS, AB, offset_ab
