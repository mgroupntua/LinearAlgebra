...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGGQRF
    {
        ...
        public DGGQRF(DGEQRF dgeqrf, DGERQF dgerqf, DORMQR dormqr, XERBLA xerbla, ILAENV ilaenv)
        {
            ...
            _dgeqrf = dgeqrf; _dgerqf = dgerqf; _dormqr = dormqr; _xerbla = xerbla; _ilaenv = ilaenv; 
                         ...
                         , ref double[] B, int offset_b, int LDB, ref double[] TAUB, int offset_taub, ref double[] WORK, int offset_work, int LWORK, ref int INFO)
        {
            ...
            NB2 = _ilaenv.Run(1, "DGERQF", " ", N, P,  - 1,  - 1);
            ...
            // *
            _dgeqrf.Run(N, M, ref A, offset_a, LDA, ref TAUA, offset_taua, ref WORK, offset_work
                             , LWORK, ref INFO);
            LOPT = (int)WORK[1 + o_work];
            // *
            // *     Update B := Q'*B.
            // *
            _dormqr.Run("Left", "Transpose", N, P, Math.Min(N, M), ref A, offset_a
            ...
            // *
            _dgerqf.Run(N, P, ref B, offset_b, LDB, ref TAUB, offset_taub, ref WORK, offset_work
                             , LWORK, ref INFO);
