...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLASY2
    {
        ...
        public DLASY2(IDAMAX idamax, DLAMCH dlamch, DCOPY dcopy, DSWAP dswap)
        {
            ...
            _idamax = idamax; _dlamch = dlamch; _dcopy = dcopy; _dswap = dswap; 
                         ...
                         , ref double[] X, int offset_x, int LDX, ref double XNORM, ref int INFO)
        {
            ...
            var BSWAP = false; var XSWAP = false; var I = 0; var IP = 0; var IPIV = 0; var IPSV = 0; var J = 0; var JP = 0; 
            var JPSV = 0;var K = 0; double BET = 0; double EPS = 0; double GAM = 0; double L21 = 0; double SGN = 0; 
            double SMIN = 0;double SMLNUM = 0; double TAU1 = 0; double TEMP = 0; double U11 = 0; double U12 = 0; double U22 = 0; 
            double XMAX = 0; var o_jpiv = -1; var offset_btmp = 0; var o_btmp = -1; 
            var offset_t16 = 0; var o_t16 = -5;var offset_tmp = 0; var o_tmp = -1; var o_x2 = -1; 
            ...
            #region Array Index Correction
             ...
             var o_tl = -1 - LDTL + offset_tl;  var o_tr = -1 - LDTR + offset_tr;  var o_b = -1 - LDB + offset_b; 
             var o_x = -1 - LDX + offset_x;
        ...
        LABEL40:;
            ...
            // *
            IPIV = _idamax.Run(4, TMP, offset_tmp, 1);
            U11 = TMP[IPIV + o_tmp];
        ...
        LABEL50:;
            ...
            BTMP[1 + o_btmp] = ZERO;
            _dcopy.Run(16, BTMP, offset_btmp, 0, ref T16, offset_t16, 1);
            ...
            for (I = 1; I <= 3; I++)
            {
                ...
                if (IPSV != I)
                {
                    _dswap.Run(4, ref T16, IPSV+1 * 4 + o_t16, 4, ref T16, I+1 * 4 + o_t16, 4);
                    TEMP = BTMP[I + o_btmp];
                    BTMP[I + o_btmp] = BTMP[IPSV + o_btmp];
                    BTMP[IPSV + o_btmp] = TEMP;
                }
                if (JPSV != I) _dswap.Run(4, ref T16, 1+JPSV * 4 + o_t16, 1, ref T16, 1+I * 4 + o_t16, 1);
                JPIV[I + o_jpiv] = JPSV;
