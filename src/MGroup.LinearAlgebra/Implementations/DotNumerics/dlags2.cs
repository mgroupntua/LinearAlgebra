    ...
    public class DLAGS2
    {
                         ...
                         , ref double SNQ)
        {
            ...
            if (UPPER)
            {
                ...
                // *
                _dlasv2.Run(A, B, D, ref S1, ref S2, ref SNR
                ...
                if (Math.Abs(CSL) >= Math.Abs(SNL) || Math.Abs(CSR) >= Math.Abs(SNR))
                {
                    ...
                    if (Math.Abs(UA11R) + Math.Abs(UA12) != ZERO)
                    {
                        ...
                        {
                            _dlartg.Run( - UA11R, UA12, ref CSQ, ref SNQ, ref R);
                        }
                        else
                        {
                            _dlartg.Run( - VB11R, VB12, ref CSQ, ref SNQ, ref R);
                        }
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (Math.Abs(UA21) + Math.Abs(UA22) != ZERO)
                    {
                        ...
                        {
                            _dlartg.Run( - UA21, UA22, ref CSQ, ref SNQ, ref R);
                        }
                        else
                        {
                            _dlartg.Run( - VB21, VB22, ref CSQ, ref SNQ, ref R);
                        }
                    }
                    else
                    {
            ...
            else
            {
                ...
                // *
                _dlasv2.Run(A, C, D, ref S1, ref S2, ref SNR
                                 , ref CSR, ref SNL, ref CSL);
                // *
                if (Math.Abs(CSR) >= Math.Abs(SNR) || Math.Abs(CSL) >= Math.Abs(SNL))
                {
                    ...
                    if (Math.Abs(UA21) + Math.Abs(UA22R) != ZERO)
                    {
                        ...
                        {
                            _dlartg.Run(UA22R, UA21, ref CSQ, ref SNQ, ref R);
                        }
                        else
                        {
                            _dlartg.Run(VB22R, VB21, ref CSQ, ref SNQ, ref R);
                        }
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (Math.Abs(UA11) + Math.Abs(UA12) != ZERO)
                    {
                        ...
                        {
                            _dlartg.Run(UA12, UA11, ref CSQ, ref SNQ, ref R);
                        }
                        else
                        {
                            _dlartg.Run(VB12, VB11, ref CSQ, ref SNQ, ref R);
                        }
                    }
                    else
                    {
