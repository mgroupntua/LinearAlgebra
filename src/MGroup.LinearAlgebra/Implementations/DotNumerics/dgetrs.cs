...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DGETRS
    {
        ...
        public DGETRS(LSAME lsame, DLASWP dlaswp, DTRSM dtrsm, XERBLA xerbla)
        {
            ...
            _lsame = lsame; _dlaswp = dlaswp; _dtrsm = dtrsm; _xerbla = xerbla; 
                         ...
                         , ref double[] B, int offset_b, int LDB, ref int INFO)
        {
            ...
            #region Array Index Correction
             ...
             var o_a = -1 - LDA + offset_a;  var o_ipiv = -1 + offset_ipiv;  var o_b = -1 - LDB + offset_b; 
            ...
            if (NOTRAN)
            {
                ...
                // *
                _dlaswp.Run(NRHS, ref B, offset_b, LDB, 1, N, IPIV, offset_ipiv
                                 , 1);
                // *
                // *        Solve L*X = B, overwriting B with X.
                // *
                _dtrsm.Run("Left", "Lower", "No transpose", "Unit", N, NRHS
                                , ONE, A, offset_a, LDA, ref B, offset_b, LDB);
                // *
                // *        Solve U*X = B, overwriting B with X.
                // *
                _dtrsm.Run("Left", "Upper", "No transpose", "Non-unit", N, NRHS
                                , ONE, A, offset_a, LDA, ref B, offset_b, LDB);
            }
            else
            {
                ...
                // *        Solve U'*X = B, overwriting B with X.
                // *
                _dtrsm.Run("Left", "Upper", "Transpose", "Non-unit", N, NRHS
                                , ONE, A, offset_a, LDA, ref B, offset_b, LDB);
                // *
                // *        Solve L'*X = B, overwriting B with X.
                // *
                _dtrsm.Run("Left", "Lower", "Transpose", "Unit", N, NRHS
                                , ONE, A, offset_a, LDA, ref B, offset_b, LDB);
                // *
