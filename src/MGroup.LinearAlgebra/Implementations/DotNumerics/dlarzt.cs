...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DLARZT
    {
        ...
        public DLARZT(DGEMV dgemv, DTRMV dtrmv, XERBLA xerbla, LSAME lsame)
        {
            ...
            _dgemv = dgemv; _dtrmv = dtrmv; _xerbla = xerbla; _lsame = lsame; 
            ...
            for (I = K; I >= 1; I +=  - 1)
            {
                ...
                else
                {
                    ...
                    if (I < K)
                    {
                        ...
                        // *
                        _dgemv.Run("No transpose", K - I, N,  - TAU[I + o_tau], V, I + 1+1 * LDV + o_v, LDV
