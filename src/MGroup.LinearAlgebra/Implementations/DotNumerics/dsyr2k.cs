...
namespace MGroup.LinearAlgebra.Implementations.DotNumerics
{
    ...
    public class DSYR2K
    {
                         ...
                         , int LDA, double[] B, int offset_b, int LDB, double BETA, ref double[] C, int offset_c, int LDC)
        {
            ...
            double TEMP1 = 0; double TEMP2 = 0; var I = 0; var INFO = 0; var J = 0; var L = 0; var NROWA = 0; var UPPER = false; 
            ...
            var C_J = 0; var A_L = 0; var B_L = 0; var A_I = 0; var B_J = 0; var B_I = 0; var A_J = 0; 
            ...
            {
                if (!_lsame.Run(TRANS, "N") && !_lsame.Run(TRANS, "T") && !_lsame.Run(TRANS, "C"))
                {
                    INFO = 2;
                }
                else
