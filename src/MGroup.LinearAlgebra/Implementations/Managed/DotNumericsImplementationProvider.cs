namespace MGroup.LinearAlgebra.Implementations.Managed
{
	...
	/// </summary>
	public class DotNumericsImplementationProvider : IImplementationProvider
	{
		private readonly double luPivotTolerance;

		public DotNumericsImplementationProvider(double luPivotTolerance = LUCSparseNet.DefaultPivotTolerance)
		{
			this.luPivotTolerance = luPivotTolerance;
			Blas = DotNumericsBlasProvider.UniqueInstance;
