namespace MGroup.LinearAlgebra.Matrices
{
	...
	/// </summary>
	public sealed class Matrix2by2 : DefaultMatrix, IEntrywiseOperableView2D<Matrix2by2, Matrix2by2>, IEntrywiseOperable2D<Matrix2by2>
	{
		...
		public override MatrixSymmetry MatrixSymmetry 
			=> data[0, 1] == data[1, 0] ? MatrixSymmetry.Symmetric : MatrixSymmetry.NonSymmetric;

		public override int NumColumns => 2;

		public override int NumRows => 2;
		...
		public static Matrix2by2 operator *(double scalar, Matrix2by2 matrix) => matrix.ScaleSameFormat(scalar);
		...
		/// <param name="matrix">The matrix to multiply.</param>
		/// <param name="scalar">The scalar value that will be multiplied with all vector entries.</param>
		public static Matrix2by2 operator *(Matrix2by2 matrix, double scalar) => matrix.ScaleSameFormat(scalar);
		...
		public override void Clear() => Array.Clear(data, 0, 4); //TODO: would it be faster to do it myself?
		...
		/// </summary>
		public Matrix2by2 CopySameType() 
			=> new Matrix2by2(new double[,] { { data[0, 0], data[0, 1] }, { data[1, 0], data[1, 1] } });
		...
		public override IMatrix CreateZeroMatrixWithSameFormat() => Matrix2by2.CreateZero();
		...
		Matrix2by2 IEntrywiseOperableView2D<Matrix2by2, Matrix2by2>.DoToAllEntries(Func<double, double> unaryOperation)
			=> DoToAllEntriesSameFormat(unaryOperation);

		public Matrix2by2 DoToAllEntriesSameFormat(Func<double, double> unaryOperation)
		{
			return new Matrix2by2(new double[,]
			{
		...
		public override bool HasSameFormat(IReadOnlyMatrix other) => other is Matrix2by2;
		...
		public Matrix2by2 ScaleSameFormat(double scalar)
		{
			return new Matrix2by2(new double[,]
			{
		...
		/// </summary>
		public Matrix2by2 TransposeSameFormat()
