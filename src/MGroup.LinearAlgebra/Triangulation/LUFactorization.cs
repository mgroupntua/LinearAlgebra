...
namespace MGroup.LinearAlgebra.Triangulation
{
	...
	public class LUFactorization : ITriangulation
	{
		...
		public Matrix Invert(bool inPlace)
		{
			...
			// Call LAPACK
			int firstZeroDiagonal = GlobalProvider.LapackLinearEquations.Dgetri(
				Order, inverse, 0, Order, rowExchanges, 0, pivotTolerance);
		...
		public void SolveLinearSystem(Vector rhs, Vector solution)
		{
			...
			GlobalProvider.LapackLinearEquations.Dgetrs(
				TransposeMatrix.NoTranspose, n, numRhs, lowerUpper, 0, n, rowExchanges, 0, solution.RawData, 0, leadingDimB);
		}
